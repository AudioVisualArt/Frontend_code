                             ...
                             return showDialog(
                                ...
                                builder: (context){
                                  ...
                                  child: Column(children: [
                                    ...
                                    SizedBox(height: 10,),
                                    Text("Contenido: ",style: TextStyle(fontStyle: FontStyle.italic,fontSize: 18,fontWeight: FontWeight.bold)),Text(actividades[index].contenido,overflow: TextOverflow.ellipsis,),
                                    ...
                                    ListTile(leading: Text("Horas: ",style: TextStyle(fontWeight: FontWeight.bold),),trailing: Text(tokens[0])),
